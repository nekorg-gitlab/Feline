...
export function CreateTab() {
  ...
  return (
    <SidebarItem active={createSelected}>
      <SidebarItemTooltip tooltip={t('Common.addSpace')}>
        {(triggerRef) => (
          <PopOut
            anchor={menuCords}
            position="Right"
                  ...
                  <Box direction="Column">
                    ...
                    >
                      <SettingTile before={<Icon size="400" src={Icons.Space} />}>
                        <Text size="H6">{t('Common.createSpace')}</Text>
                        <Text size="T300" priority="300">
                          {t('Common.buildASpaceForYourCommunity')}
                        </Text>
                      </SettingTile>
                    </SequenceCard>
                    <SequenceCard
                    ...
                    >
                      <SettingTile before={<Icon size="400" src={Icons.Link} />}>
                        <Text size="H6">{t('UI.joinWithAddress')}</Text>
                        <Text size="T300" priority="300">
                          {t('Common.becomeAPartOfExistingCommunity')}
                        </Text>
                      </SettingTile>
                    </SequenceCard>
                  </Box>
