  ...
  return (
    <Box direction="Column" gap="100">
      <Box alignItems="Center" justifyContent="SpaceBetween" gap="200">
        <Text size="L400">{t('Common.specialMessages')}</Text>
        <Box gap="100">
      ...
      >
        <SettingTile
          title={`${t('UI.mentionUserId')} ("${userId}")`}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={`${t('UI.containsDisplayname')} ${displayName ? `("${displayName}")` : ''}`}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
      ...
      >
        <SettingTile
          title={`${t('UI.containsUsername')} ("${getMxIdLocalPart(userId)}")`}
          after={
            <MentionModeSwitcher
              pushRules={pushRules}
