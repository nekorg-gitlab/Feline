        ...
        <Scroll hideTrack visibility="Hover">
          <PageContent>
            <Box direction="Column" gap="700">
              <Box direction="Column" gap="100">
                <Text size="L400">{t('Common.security')}</Text>
                <SequenceCard
                ...
                >
                  <SettingTile
                    title={t('Common.deviceVerification')}
                    description={t('UI.toVerifyDeviceIdentityAndGrantAccessToEn')}
                    after={
                      <>
              ...
              <Box direction="Column" gap="100">
                <Text size="L400">{t('Common.current')}</Text>
                {currentDevice ? (
                  <SequenceCard
                    className={SequenceCardStyle}
                    variant="SurfaceVariant"
