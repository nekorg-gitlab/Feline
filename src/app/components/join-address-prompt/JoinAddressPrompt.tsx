      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{t('UI.joinWithAddress')}</Text>
              </Box>
            ...
            >
              <Box direction="Column" gap="200">
                <Text priority="400" size="T300">
                  {t('UI.enterPublicAddressToJoinTheCommunityAddr')}
                </Text>
              ...
              <Box direction="Column" gap="100">
                <Text size="L400">{t('Common.address')}</Text>
                <Input
                  size="500"
                  autoFocus
                  name="addressInput"
                ...
                {invalid && (
                  <Text size="T200" style={{ color: color.Critical.Main }}>
                    <b>{t('Common.invalidAddress')}</b>
                  </Text>
                )}
              </Box>
              <Button type="submit" variant="Primary">
                <Text size="B400">{t('Common.open')}</Text>
              </Button>
            </Box>
          </Dialog>
        </FocusTrap>
